...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '盒子外工坊', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '小站搭建中，敬请期待', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://outofbox-workshop.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,blog,outofbox,outofbox-workshop,miniature,miniature painting', // 网站关键词 英文逗号隔开
